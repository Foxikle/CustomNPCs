 ...
 */
public class FakeListener_v1_20_R3 extends ServerGamePacketListenerImpl {
    /**
     ...
     * @param npc The NPC
     */
    public FakeListener_v1_20_R3(MinecraftServer server, Connection connection, ServerPlayer npc) {
